    ...
    <div className="flex flex-col min-h-screen bg-gray-800">
      <header className="text-white w-full relative z-30">
        <div className="flex justify-between items-center p-4">
          <h1 className="text-xl md:text-3xl font-bold">Auto Keyz</h1>
          <button
            aria-label="Menu"
          ...
          <nav className={`${isMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row absolute md:relative inset-x-0 top-full md:top-auto bg-gray-800 md:bg-transparent w-full md:w-auto p-4 md:p-0 z-50`}>
      ...
      <footer className="bg-gray-700 text-white w-full p-4">
